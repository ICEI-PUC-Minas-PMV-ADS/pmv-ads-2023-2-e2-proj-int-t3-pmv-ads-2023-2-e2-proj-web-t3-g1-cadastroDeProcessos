                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            html += "<TR><TD><input type='checkbox' id='setor_" + codigoSetor + "'></TD><TD>" + nome + "</TD></TR>";


                            html += "<SCRIPT>$('setor_" + codigoSetor + "').change(function(){vincularUsuarioSetor(valor('cpfUsuario'), " + codigoSetor + ")});</SCRIPT>";

                            html += "<SCRIPT>$('setor_" + codigoSetor + "').click(function(){vincularUsuarioSetor(valor('cpfUsuario'), " + codigoSetor + ")});</SCRIPT>";
